...
import { getDayDayPeriod, getSeason, TRANS_WORDS, updateBackgroundImage, WEATHER_CONDITIONS } from '../constraints/unitls';
	...
	return (
		<div className="weather">
			<div className="temperature">
				<div className="temperature_place">{location.name}</div>
			...
			<div className="weatherDetails">
				...
				<span>
					{TRANS_WORDS.FEELS_LIKE[language.TITLE]}:{weather.feels_like}
					{unit.SIGN}
				</span>
				<ul>
					<li>
						{TRANS_WORDS.SPEED[language.TITLE]}:{weather.wind_speed}
						{TRANS_WORDS.M_S[language.TITLE]}
					</li>
					<li>
						{TRANS_WORDS.HUMIDITY[language.TITLE]}:{weather.humidity}%
					</li>
				</ul>
			</div>
		</div>
