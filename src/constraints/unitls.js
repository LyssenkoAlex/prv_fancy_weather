...
export const UNIT = {
	IMPERIAL: { TYPE: 'imperial', SIGN: '°F', NAME: 'IMPERIAL' },
	METRIC: { TYPE: 'metric', SIGN: '°C', NAME: 'METRIC' }
};
export const LANGUAGE = {
	RU: { TITLE: 'RU', VALUE: 'ru', REC: 'ru' },
	ENG: { TITLE: 'ENG', VALUE: 'en', REC: 'en-US' },
	KAZ: { TITLE: 'KAZ', VALUE: 'kk', REC: 'ru' }
};
