...
const WeatherForecast = () => {
	...
	const weather = weatherDaily.map((day, i) => {
		return (
			<div key={i} className="forecastDetails">
				...
				<img
					src={WEATHER_CONDITIONS[day.main] === undefined ? '#' : WEATHER_CONDITIONS[day.main].ICON}
					alt={day.main}
	...
	return <div className="weatherForeCast">{weather}</div>;
};
